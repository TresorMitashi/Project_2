...
# load data
# load data
engine = create_engine('sqlite:///../data/DISASTER_CLEAN.db')
    ...
    graphs = [
        {
            ...
            'layout': {
                'title': 'Statistic regarding the genre of messages',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
                    'title': "Genre of messages"
                }
            }
        },
        {
            ...
            'layout': {
                'title': 'Statistic regarding the catgeory of messages',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
